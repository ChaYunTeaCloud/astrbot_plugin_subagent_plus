...
from .web_api import register_page_apis
...
class MyPlugin(Star):
    ...
    async def on_llm_request(self, event: AstrMessageEvent, req: ProviderRequest):
        ...
        req.func_tool.add_tool(self._p_tool_mgr.get_list_subagent_tool())
        req.func_tool.add_tool(self._p_tool_mgr.get_call_subagent_tool())
        return None
